...
- [第 22 周：预训练数据从哪里来](../weeks/22_data_governance.md)
- [第 23 周：过滤、去重与数据混合](../weeks/23_dedup_mixing_packing.md)
- [第 24 周：优化器、Warmup 与学习率计划](../weeks/24_adamw_schedules.md)
- [第 25 周：FLOPs、显存与混合精度](../weeks/25_mixed_precision_resources.md)
- [第 26 周：并行训练、检查点与故障恢复](../weeks/26_parallel_checkpointing.md)
- [第 27 周：Scaling Laws 与计算最优](../weeks/27_scaling_and_evaluation.md)
- [第 28 周：可靠评测、去污染与故障诊断](../weeks/28_reliable_evaluation.md)
