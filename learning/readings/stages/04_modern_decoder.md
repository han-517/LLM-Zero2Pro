...
- [第 16 周：Pre-Norm 与 RMSNorm](../lessons/16_rmsnorm_prenorm.md)
- [第 17 周：SwiGLU 与门控 MLP](../lessons/17_swiglu.md)
- [第 18 周：RoPE：用旋转编码相对位置](../lessons/18_rope_and_extensions.md)
- [第 19 周：MQA 与 GQA](../lessons/19_mqa_gqa.md)
- [第 20 周：KV Cache 与逐 token 解码](../lessons/20_kv_cache_decode.md)
- [第 21 周：初始化、AdamW 与训练稳定性](../lessons/21_initialization_stability.md)
