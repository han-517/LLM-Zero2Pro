...
- [第 40 周：指令数据与 SFT](../lessons/40_sft_data_contract.md)
- [第 41 周：LoRA 与 QLoRA](../lessons/41_lora_qlora.md)
- [第 42 周：偏好、奖励模型与 PPO](../lessons/42_reward_model_ppo.md)
- [第 43 周：DPO：绕开奖励模型的偏好优化](../lessons/43_dpo_preference_optimization.md)
- [第 44 周：GRPO、RLVR 与推理训练](../lessons/44_grpo_rlvr_reasoning.md)
