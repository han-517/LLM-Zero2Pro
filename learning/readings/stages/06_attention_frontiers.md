...
- [第 29 周：FlashAttention 与 IO-aware 思维](../lessons/29_flashattention.md)
- [第 30 周：滑窗、块稀疏与全局 token](../lessons/30_sparse_attention.md)
- [第 31 周：MLA 与低维 KV 表示](../lessons/31_mla.md)
- [第 32 周：线性注意力的结合律与归一化状态](../lessons/32_linear_attention.md)
- [第 33 周：Mamba-2、DeltaNet 与选择性状态更新](../lessons/33_gated_deltanet.md)
- [第 34 周：混合架构、DSA 与长上下文评测](../lessons/34_hybrid_dsa_evaluation.md)
