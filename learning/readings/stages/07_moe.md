...
- [第 35 周：条件计算与 Top-k 路由](../lessons/35_topk_routing.md)
- [第 36 周：容量、token dropping 与负载均衡](../lessons/36_capacity_and_balance.md)
- [第 37 周：Router z-loss、数值精度与稳定性](../lessons/37_router_stability.md)
- [第 38 周：共享专家、细粒度专家与 upcycling](../lessons/38_shared_experts_upcycling.md)
- [第 39 周：专家并行、DeepSeekMoE 与现代变体](../lessons/39_expert_parallel.md)
