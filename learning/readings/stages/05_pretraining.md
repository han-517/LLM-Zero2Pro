...
- [第 22 周：预训练数据从哪里来](../lessons/22_data_governance.md)
- [第 23 周：过滤、去重与数据混合](../lessons/23_dedup_mixing_packing.md)
- [第 24 周：优化器、Warmup 与学习率计划](../lessons/24_adamw_schedules.md)
- [第 25 周：FLOPs、显存与混合精度](../lessons/25_mixed_precision_resources.md)
- [第 26 周：并行训练、检查点与故障恢复](../lessons/26_parallel_checkpointing.md)
- [第 27 周：Scaling Laws 与计算最优](../lessons/27_scaling_and_evaluation.md)
- [第 28 周：可靠评测、去污染与故障诊断](../lessons/28_reliable_evaluation.md)
...
5. 并行训练、状态分片、检查点与故障恢复。
6. Scaling Laws 与计算最优。
7. 可重复评测、去污染、消融和训练报告。
