...
- [第 5 周：监督学习、泛化与数据切分](../lessons/05_supervision_generalization.md)
- [第 6 周：MLP、激活函数与优化](../lessons/06_mlp_activations_optimization.md)
- [第 7 周：词向量与神经语言模型](../lessons/07_embeddings_neural_lm.md)
- [第 8 周：RNN、状态与序列瓶颈](../lessons/08_rnn_state_and_sequence_bottleneck.md)
...
运行 [`core/02_neural_language_models.ipynb`](../../labs/02_neural_language_models.ipynb)，按顺序完成：
