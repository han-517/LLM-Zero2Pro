...
在 `learning/labs/07_pretraining_systems.ipynb` 画 LR 与参数范数曲线；完成 starter `15` 的 AdamW 单步和 schedule。`learning/readings/interactive/training-and-alignment.html` 用于连接训练内存与目标，本周数值验收以单步 tensor oracle 为主。
