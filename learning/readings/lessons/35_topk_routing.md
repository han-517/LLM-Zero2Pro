...
[现代 Decoder Notebook](../../labs/06_modern_decoder.ipynb) 中 SwiGLU 的输入输出，
再打开 [MoE Notebook](../../labs/09_moe.ipynb)。MoE 通常替换的是 FFN 子层，
...
完成 [starter 10](../../labs/starter/10_moe_router.py) 时应保持相同数学语义，再用
参考实现测试梯度和边界。
