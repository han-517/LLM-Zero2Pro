...
在 `learning/labs/06_modern_decoder.ipynb` 对比 GELU MLP 与 SwiGLU 的参数、MAC、激活直方图和单步梯度；完成 starter `09` 的门控部分。`learning/readings/interactive/architecture-evolution.html` 用于观察公开模型的组件组合，但参数核算必须由代码输出验证。
